...
// ── Bio Dev Panel ────────────────────────────────────────────────────────────
let _simulateBioSession = null;
let _toggleDevPanel = null;
...
if (import.meta.env.DEV) {
     ...
     */
    _simulateBioSession = async function (profileKey, storage) {
    ...
    /** Toggle the floating Dev Mode panel (toggled by long-press on the version footer). */
    _toggleDevPanel = function (storage) {
...
async function boot() {
    ...
    // 6. Version footer — DEV-only long-press opens dev panel
